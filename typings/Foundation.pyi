...
class NSNotificationCenter(NSObject):
    def addObserver_selector_name_object_(
        self, observer: NSObject, selector: str, name: str, object: Optional[NSObject]
    ) -> None: ...
...
NSNotificationSuspensionBehaviorDeliverImmediately = (
    NSNotificationSuspensionBehavior.NSNotificationSuspensionBehaviorDeliverImmediately
)
